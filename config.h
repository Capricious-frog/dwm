...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { fg, 	    bg2,       col_gray2 },
	[SchemeSel]  = { bg0_s,	    fg4,       col_cyan  },
};
...
static const Rule rules[] = {
	...
	{ "librewolf",		NULL,	    NULL,       	2 << 9,     0,           0,		0,	    -1,		-1 },
	{ "Steam",		NULL,	    "Friends List",     0,	    0,           1,		0,	    -1,		-1 },
	{ "warframe.x64.exe",   NULL,	    "Warframe",		0,	    1,           1,		0,	    -1,		-1 },
...
static const char *dmenucmd[] = { "dmenu", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *roficmd[] = { "rofi", "-show", "drun", "-show-icons", NULL };
static const char *termcmd[]  = { "alacritty", NULL };
static const char *browsercmd[] = { "librewolf", NULL };
static const char *screenLock[] = { "betterlockscreen", "-l", "dimblur", NULL };
static const char *volUp[] = { "pulseaudio-ctl", "up", "1", NULL };
static const char *volDown[] = { "pulseaudio-ctl", "down", "1", NULL };
static const char *mute[] = { "pulseaudio-ctl", "mute", "toggle", NULL };
static const char *playerPause[] = { "pulseaudio-ctl", "play-pause", NULL };
...
static Key keys[] = {
	...
	{ 0,                            XF86XK_MonBrightnessDown,       spawn,          {.v = brightnessUp } },
